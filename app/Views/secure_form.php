...
<head>
    ...
    <style>
        ...
        input[type="text"] { width: 100%; padding: 0.7rem; background: #0d1117; border: 1px solid #30363d; border-radius: 8px; color: #e6edf3; font-size: 0.95rem; margin-bottom: 1.2rem; }
        button { width: 100%; padding: 0.75rem; background: #238636; color: #fff; border: none; border-radius: 8px; font-size: 1rem; cursor: pointer; }
        button:hover { background: #2ea043; }
        code { background: #0d1117; padding: 2px 6px; border-radius: 4px; color: #79c0ff; font-size: 0.85rem; }
    </style>
</head>
<body>
<div class="card">
